...
import 'package:nirvana/components/chat_bubble.dart';
      ...
      void initState(){
        ...
        myFocusNode.addListener(() {
          if(myFocusNode.hasFocus){
            ...
            // cause a delay so that the kyboard has time to show up
            // then the amount of remaining spac will be calculated
            // then scroll down
...
var alignment =
  ...
  Widget _buildUserInput(){
    return Padding(
      ...
      child: Row(
        children: [
          // textfield should take up most of th space
          Expanded(child: MyTextField(
            hintText: "Type a message", obscureText: false, controller: _messageController, focusNode: myFocusNode,)),
