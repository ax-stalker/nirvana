...
class MyBusinessRegistration extends StatefulWidget {
  final void Function()? onPressed;
   ...
   MyBusinessRegistration({super.key, required this.onPressed, });
...
class _MyBusinessRegistrationState extends State<MyBusinessRegistration> {
  ...
  _businessLocationController.text=position.latitude.toString()+','+position.longitude.toString();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // business name textfield
        MyTextField(controller: _businessNameController, hintText: 'Business name',obscureText: false,   ),
        SizedBox(height:15),
         ...
         // Business category 
          ...
          StreamBuilder(
            ...
            builder: (context, snapshot){
              if(!snapshot.hasData){
                return Center(child: Text('Some errors occurred ${snapshot.error}'),);
              }
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton( 
                      ...
                      items: categoryItems, onChanged: (value){
                        setState(() {
                          _category =value!;
                        });
                      print(value);
      ...
      // business phone number textfield
       MyTextField(controller: _businessPhoneNumberController, hintText: 'Business phone number',obscureText: false, ),
        SizedBox(height:15),


      // location button
      ElevatedButton(onPressed: getLocation,
