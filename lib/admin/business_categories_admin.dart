...
class BusinessCategoriesAdmin extends StatefulWidget {
  @override
  _BusinessCategoriesAdminState createState() => _BusinessCategoriesAdminState();
}

class _BusinessCategoriesAdminState extends State<BusinessCategoriesAdmin> {
